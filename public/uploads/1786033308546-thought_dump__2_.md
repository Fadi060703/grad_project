...
3. **(Fadi)** proper error handling (class) (used like: throw new UnauthError(message))
4. **(Fadi)** announecements from backend (all logic handled)
5. **(Fadi)** notification service ( single | announcement )
